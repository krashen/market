...
export const signOutFailed = (error) => createAction(USER_ACTION_TYPES.SIGN_OUT_START, error);

export const clearError = () => createAction(USER_ACTION_TYPES.CLEAR_ERROR);